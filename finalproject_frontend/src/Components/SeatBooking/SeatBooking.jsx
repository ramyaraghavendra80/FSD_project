...
function SeatBooking() {
  ...
  const handleSubmit = async (e) => {
    ...
    const requestData = {
      ...
      price: formData.price, // Use formData.price here
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...formData,
          price: data.total_price, // Update formData.price here
        });
    ...
    <div className="seatform">
      ...
      {isBookingSuccessful ? (
        ...
        <div className="confirmation-modal">
          ...
          <p>User: {username}</p>
          <button className="modalbutton" onClick={handleConfirmBooking}>
            Confirm
          </button>
          <button
