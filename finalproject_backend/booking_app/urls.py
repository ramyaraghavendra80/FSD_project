...
from .views import TicketList,BookingConfirmation,SeatList,UserList, UserDetails,MovieDetail,TheaterListView, TheaterDetailView,SignupView, SigninView, LogoutView,SearchView,PaginateMovies,PaginateSearchMovies,MovieList
...
urlpatterns = [
    ...
    path('movies/add/', MovieDetail.as_view(), name='add-movie'),
    path('movies/<int:movie_id>/update/', MovieDetail.as_view(), name='update-movie'),
    path('movies/<int:movie_id>/delete/', MovieDetail.as_view(), name='delete-movie'),
    ...
    path('tickets/', csrf_exempt(TicketList.as_view()), name='ticket-list'),
    # Booking Confirmation page
    path('booking-confirmation/<int:booking_id>/', BookingConfirmation.as_view(), name='booking-confirmation'),
    path('booking-confirmation/', BookingConfirmation.as_view(), name='booking-confirmation'),
